 ...
 * Author: John Burket
 *
 * This is a quick and dirty GUI I put together in an evening as a front
 * end to my Cantonese data sets.  Note that at the time this was written I
 * was targeting a Java 1.4 environment, so no 1.5+ features are used.
 *
 * I originally wrote this utility for my own personal use but since a number
 * of people have asked for the source code, I decided to make it available
 * online.
 */
